function [nl, gradnl] = learn_mtgp(logtheta, logtheta_all, covfunc_x, x, y,...
				      m, irank, nx, ind_kf, ind_kx, deriv_range)
% [nl, gradnl] = learn_mtgp(logtheta, logtheta_all, covfunc_x, x, y,...
%                	      m, irank, nx, ind_kf, ind_kx, deriv_range)
% Learns a Multi-task Gaussian process model
...
%
% nl = learn_mtgp(logtheta, ...) Returns the marginal negative log-likelihood
% [nl gradnl] =  learn_mtgp(logtheta, ...) Returns the gradients wrt logtheta
%
