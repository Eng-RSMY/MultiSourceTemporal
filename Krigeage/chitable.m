function X2 = chitable(P,v)
%CHITABLE computes the "percentage points" of the
%chi-squared distribution, as in Abramowitz & Stegun Table 26.8
%   X2 = CHITABLE( P, v ) returns the value of chi-squared 
